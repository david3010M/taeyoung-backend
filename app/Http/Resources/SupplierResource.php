...
class SupplierResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'document' => $this->typeDocument === 'OTRO' ? $this->document : null,
            'dni' => $this->typeDocument === 'DNI' ? $this->dni : null,
            'ruc' => $this->typeDocument === 'RUC' ? $this->ruc : null,
            'names' => $this->typeDocument === 'DNI' || $this->typeDocument === 'OTRO' ? $this->names : null,
            'fatherSurname' => $this->typeDocument === 'DNI' || $this->typeDocument === 'OTRO' ? $this->fatherSurname : null,
