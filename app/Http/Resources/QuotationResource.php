 ...
 *     required={
 *       "id", "number", "date", "detail", "paymentType", "currencyType",
 *       "totalMachinery", "totalSpareParts", "subtotal", "igv", "discount", 
 *       "total", "client_id"
 *     },
 ...
 *         type="array",
 *         @OA\Items(ref="#/components/schemas/DetailMachineryResource")
 *     ),
 *     @OA\Property(
 *         property="detailSpareParts",
 *         type="array",
 *         @OA\Items(ref="#/components/schemas/DetailSparePartResource")
 *     )
 * )
 *
 * @OA\Schema (
...
class QuotationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'client'         => $this->client ? $this->client->filterName : null,
            'clientData'     => new ClientResource($this->client),
            'status'         => $this->status,  // <-- Nuevo campo
